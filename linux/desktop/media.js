...
function explainMedia(error, file) {
 ...
 return plain(`${name} can't be opened as a video: ${MEDIA_ERRORS[code] || 'the decoder failed'}. For other formats install ffmpeg (sudo apt install ffmpeg), extract PNG frames with it and look at them with read_file.`);
}
